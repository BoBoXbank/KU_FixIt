...
## ฟีเจอร์หลัก
* **ระบบสมาชิก (User):** * สมัครสมาชิกด้วยอีเมล `@ku.th` เท่านั้น พร้อมระบบยืนยันตัวตนผ่าน **OTP Email** 
    * ระบบคำถามความปลอดภัยสำหรับรีเซ็ตรหัสผ่าน 
    * ระบบป้องกันการ Login ผิด (Lockout 2 นาที เมื่อผิดครบ 10 ครั้ง) 
* **ระบบรายงาน (Reporting):** * แจ้งซ่อมพร้อมระบุสถานที่ ประเภทงาน และรายละเอียด 
    * อัปโหลดรูปภาพประกอบ (มีระบบบีบอัดไฟล์อัตโนมัติเพื่อประหยัดพื้นที่ฐานข้อมูล) 
* **ระบบช่าง (Technician):** * แยกหน้า Dashboard ตามแผนก (แอร์, ไม้, WiFi, ประปา, ไฟฟ้า) 
    * ระบบกดรับงาน (Claim) และอัปเดตสถานะการดำเนินงาน 
* **ระบบผู้ดูแลระบบ (Admin):** * จัดการสถานะรายงานและรายชื่อผู้ใช้งาน 
    * **Security Control:** ระบบแบน/ปลดแบน IP Address ของผู้ใช้งานที่ทำผิดกฎ 
* **ความปลอดภัย (Security):** * Password Hashing และเชื่อมต่อฐานข้อมูลผ่าน SSL 
    * ป้องกัน Bot ด้วย Google reCAPTCHA
